...
class StartMenuWidgetFour extends StatefulWidget {
  final String player;
  const StartMenuWidgetFour({required this.player});

  @override
  State<StartMenuWidgetFour> createState() => _StartMenuWidgetFourState();
}

class _StartMenuWidgetFourState extends State<StartMenuWidgetFour> {
