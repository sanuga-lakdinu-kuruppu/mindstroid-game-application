...
class NameWidgetFour extends StatefulWidget {
  const NameWidgetFour({super.key});

  @override
  State<NameWidgetFour> createState() => _NameWidgetFourState();
}

class _NameWidgetFourState extends State<NameWidgetFour> {
                ...
                return Dialog(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        StartMenuWidgetFour(player: _nameController.text),
                      ],
                    ),
                  ),
                );
